...
export const defaultOptions = Object.freeze({
  ...
  release: 0.5, // time taken for the level to decay to zero after key is released (or undefined to play rest of sound)
});
...
export default class Player {
  ...
  _decaySound(sound, note, duration, interval = 0.1, gainDecrement) {
    ...
    this.decayTimers[note] = setTimeout(() => this._decaySound(sound, duration - interval, interval, gainDecrement), interval * 1000);
  }
